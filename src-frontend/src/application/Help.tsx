export default function Help() {
    return <>
        <div className={"application-home"}>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/char.png" /></p>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/homesite.png" /></p>
            <p>The map will appear with red markers on it. Such a marker is called a region marker. Clicking on it
                ...
                starting site.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/homesite-map.png" /></p>
            <p>After having clicked on the site, the map window closes and the site is set.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/homesite-done.png" /></p>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/movement-1.png" /></p>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/movement-2.png" /></p>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/movement-3.png" /></p>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/hazard-1.png" /></p>

            <p>Hazards may also be attached to a specific chraracter, e.g. corruption cards.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/hazard-2.png" /></p>

            <p>To force a company or character to face hazard, drop it onto the regions and it will appear next to
                the site.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/hazard-3.png" /></p>
            <p className="center"><img alt="sample image" src="/media/assets/help/hazard-4.png" /></p>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/agent-1.png" /></p>
            ...
            <p className="center">
                <img alt="sample image" src="/media/assets/help/agent-2.png" />
                <img alt="sample image" src="/media/assets/help/agent-3.png" />
            </p>
            <p>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/agent-4.png" /></p>

            <h2 id="mps">Obtaining Marshalling Points</h2>
            <p>To obtain marshalling points, simply drag a card onto your vicotry pile.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/score-1.png" /></p>
            <p>This will open a window that lets you choose the category and amount of points.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/score-2.png" /></p>
            ...
            <p className="center"><img alt="sample image" src="/media/assets/help/nmh-1.png" className="center" />
                <img alt="sample image" src="/media/assets/help/nmh-2.png" /></p>
            <p>This action will reduce the sitepath to the destiation site only. On guard cards will be kept
                attached to the site.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/nmh-3.png" /></p>

            <h2 id="scores">Updating your scores</h2>
            <p>Click on the victory pile icon to open the score sheet.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/score-3.png" /></p>
            <p>You can change your points at any time during the game.</p>
            <p className="center"><img alt="sample image" src="/media/assets/help/score-4.png" /></p>
            ...
            <p className="center">
                <img alt="sample image" src="/media/assets/help/tap-1.png" />
                <img alt="sample image" src="/media/assets/help/tap-2.png" />
            </p>

            <p>The context menu provides all available actions.</p>
            <p className="center">
                <img alt="sample image" src="/media/assets/help/tap-3.png" />
                <img alt="sample image" src="/media/assets/help/tap-4.png" />
            </p>
