...
export default function About() {
    ...
    <div className={"application-home"}>
        ...
        <p>You can read the full license text at <a href="https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html" rel="noreferrer" target="_blank">https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html</a></p>
    </div>
    </>;
}