        ...
        div.innerHTML = `
            <div class="view-card-list-container blue-box" data-class="view-card-list-container blue-box" >
                <div class="container-title-bar smallCaps">
                    ...
                    <div class="container-title-bar-shuffle hideOnOffer fr">${Dictionary.get("close_and_shuffle", "Clsoe & Shuffle")}</div>
                    <div class="clear"></div>
                </div>
