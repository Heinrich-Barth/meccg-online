...
CardPreview.getTargetContainer = function(bLeft:boolean, bTop:boolean)
{
    if (bLeft)
...
CardPreview.checkIdle = function()
{
    ...
    document.body.dispatchEvent(new CustomEvent("meccg-notify-info", { "detail": Dictionary.get("warn_idle", "You have been idle for too long. Please interact with a card.") }));
}

CardPreview.addHover = function(id:string, bRight:boolean, bTop:boolean)
{
...
CardPreview.getElementPositionIsLeft = function(elem:any)
{
 ...
 * @return {void}
 */
CardPreview.show = function(img:string, bLeft:boolean, bTop:boolean)
{
...
CardPreview.onHoverCharacter = function(img:any)
{
    CardPreview.currentCharacterId = "";
    CardPreview.currentCardId = "";
    CardPreview.currentCardCode = "";
...
CardPreview.hide = function(bLeft:boolean, bTop:boolean)
{
    CardPreview.currentCharacterId = "";
    CardPreview.currentCardId = "";
    CardPreview.currentCardCode = "";
...
CardPreview.initMapViewCard = function(elem:any)
{
    elem.onmouseover = CardPreview._doHoverOnGuard;
    elem.onmouseout = CardPreview.hideAll;
};

CardPreview.initGeneric = function(cardDiv:any)
{
    if (cardDiv === null)
        return;
...
CardPreview.initOnGuard = function(cardDiv:any)
{
    CardPreview.initGeneric(cardDiv, true);
};

CardPreview.init = function(cardDiv:any)
{
    CardPreview.initGeneric(cardDiv, false);
};

CardPreview._getImage = function(elem:any)
{
...
CardPreview._isBackside = function(src:string)
{
    return src.indexOf("/backside") !== -1
};

CardPreview._isMyCard = function(elem:any)
{
 ...
 */
CardPreview._doHoverOnGuard = function(e:any)
{
...
CardPreview.isOnLeft = function(e:any)
{
...
CardPreview.showImage = function(elem:any, isLeft:boolean)
{
    if (elem === null)
        return;
...
CardPreview._initView = function(sId:string)
{
...
CardPreview.onDocumentReady = function()
{
    ...
    link.setAttribute("href","/dist-client/css/card-preview.css?t=" + Date.now());
