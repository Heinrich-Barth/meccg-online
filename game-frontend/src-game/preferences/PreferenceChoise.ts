...
import { PreferencesStorable } from "./preferences";

export default class PreferenceChoise extends PreferencesStorable
{
    insertOption(_elem:any)
    {
    ...
    addOptions(folder:any, container:any)
    {
    ...
    init(sUrl:string)
    {
        if (sUrl !== "")
        {
            ...
            .catch((e) => document.body.dispatchEvent(new CustomEvent("meccg-notify-error", { "detail": Dictionary.get("prefch_dice", "Could not fetch dices.") })));
        }
    }
